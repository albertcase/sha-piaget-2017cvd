    ...
    var _base = function () {
        ...
        _createClass(_base, [{
            ...
            value: function sectionChange(n) {
                ...
                if (n == 'index') {
                    document.getElementById('dreambox').className = '';
                } else {
                    document.getElementById('dreambox').className = 'inside';
                }
            }
        }, {
            key: "formErrorTips",
            ...
            value: function loadingFnDoing(allAmg, loadCallback) {
                this.loadFn(allAmg, function () {
                    ...
                    //     if(img.getAttribute('sourcesrc')){
                    //         img.setAttribute('src', img.getAttribute('sourcesrc'));
                    //     } 
                    // })
                    // _imgs.map(v => {
                    //     if(v.getAttribute('sourcesrc')){
                    //         v.setAttribute('src', v.getAttribute('sourcesrc'));
                    //     } 
                    // })
