...
;(function () {
    ...
    function _form() {
        ...
        this.createCheck = function () {
            var toName = document.querySelector('.to-name input').value.replace(/\u2006/g, ''),
                toMsg = document.querySelector('.msg-content textarea').value,
                fromName = document.querySelector('.from-name input').value.replace(/\u2006/g, '');
            ...
            __base.ajaxFun(type, url, data, function (result) {
                ...
                if (el === 'create') {
                    if (result.status == 1) {
                        shareSet_create = {
                            "_title": '因为你，所以爱', //分享标题
                            "_desc": "这个七夕，我想对你大声说：因为你是你，所以我爱你！", // 分享朋友圈的描述
                            ...
                            "_shareAppMessageCallback": function _shareAppMessageCallback() {
                                _hmt.push(['_trackEvent', 'buttons', 'share', 'onMenuShareAppMessage(创建成功)']);
                            },
                            "_shareTimelineCallback": function _shareTimelineCallback() {
                                _hmt.push(['_trackEvent', 'buttons', 'share', 'onMenuShareTimeline(创建成功)']);
                            }
                        };
                        ...
                        document.getElementById('createPic').src = result['work_img__url'];

                        __base.wxshareFun(shareSet_create);

                        __defaultSet.isJoin(is_write);

                        _hmt.push(['_trackEvent', 'buttons', 'click', '生成卡片']);
                    }
                } else {
        ...
        _createClass(defaultSet, [{
            ...
            value: function videoFun() {
                ...
                poster.addEventListener('touchstart', function (e) {
                    ...
                    _hmt.push(['_trackEvent', 'buttons', 'video', '视频播放']);
                });
            }
        }, {
            key: 'init',
            ...
            value: function startAni() {
                ...
                function aniUpdate() {
                    ...
                    var p = 1 + Math.floor((currentTime - startTime) / cycle);
            ...
            key: 'createAniCanvas',
            value: function createAniCanvas() {
                ...
                function aniUpdate() {
                    ...
                    if (imgArray.indexOf(p) < 0) {
                        imgArray.push(p);
                        self.aniCanvas(ctx, p, cwidth, cheight);
                    }
                    ...
                    if (p < aniPicNum) {
                        ...
                        __base.sectionChange("works");
                        __base.elFadeOut(c, function () {
                            c.className = 'transition hidden';
                        });
                    }
                }
                requestAnimationFrame(aniUpdate);
            ...
            key: 'aniCanvas',
            value: function aniCanvas(cxt, url, w, h) {
                var img = new Image();
                img.src = "/build/dist/img/ani/" + url + ".jpg";
                img.onload = function () {
    ...
    window.addEventListener("DOMContentLoaded", function () {
        ...
        __base.loadingFnDoing(allimg, function () {
            ...
            applyBtn.onclick = function () {
                ...
                __base.sectionChange('all-store');

                _hmt.push(['_trackEvent', 'buttons', 'click', '获取伯爵玫瑰']);
            };
            ...
            document.querySelector('.foot-rule__info').onclick = function () {
                ...
                video.pause();
                __base.overscroll(document.querySelector(".p-model-con"));
                _hmt.push(['_trackEvent', 'link', 'click', '点击查看活动详情']);
            };
            ...
            document.querySelector('.pack-link').onclick = function () {
                ...
                _hmt.push(['_trackEvent', 'link', 'click', '条款与细则']);
            };
            ...
            document.querySelector('.continue-btn').onclick = function () {
                ...
                __base.wxshareFun(shareSet_create);
                _hmt.push(['_trackEvent', 'buttons', 'click', '点击继续']);
            };
    ...
    window.addEventListener("load", function () {
        ...
        // 店铺列表弹层关闭事件
        var allstoreClose = document.querySelector('.allstore-close');
        allstoreClose.addEventListener('click', function () {
            __base.sectionChange('works');
        });
    }, false);
})();