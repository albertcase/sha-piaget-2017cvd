...
;(function () {
    ...
    window.addEventListener("DOMContentLoaded", function () {
        ...
        __base.loadingFnDoing(allimg, function () {
            ...
            // 创建换行
            document.querySelector('.msg-content textarea').onkeydown = function () {
            ...
            citySelect.addEventListener('change', function () {
                ...
                __base.overscroll(document.querySelector(".store-list__scroll"));
            });
