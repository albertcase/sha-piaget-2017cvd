            ...
            __base.ajaxFun(type, url, data, function (result) {
                ...
                if (el === 'create') {
                    if (result.status == 1) {
                        ...
                        document.getElementById('zuopin').innerHTML = '<img src="' + result['work_img__url'] + '" width="100%" /><div class="foot">\n                                                                            <p>\u957F\u6309\u4FDD\u5B58\u5361\u7247<br>\n                                                                               \u4E5F\u53EF\u5206\u4EAB\u7ED9\u4F60\u7684TA\u548C\u597D\u53CB</p>\n                                                                            <span class="btn">\n                                                                                <a href="javascript:void(0);" class="apply-btn"></a>\n                                                                                <img src="" sourcesrc="/build/dist/img/apply-btn.png" width="100%" />\n                                                                            </span>\n                                                                        </div>';
